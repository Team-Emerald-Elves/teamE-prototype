...
export function DocumentsTable<TData extends Document, TValue>({
    ...
    const [fileFilters, setFileFilters] = useState([
        {
            key: "mime_type",
            value: mime.getType("docx"),
            id: ".docx",
            state: false,
        },
        {
            key: "mime_type",
            value: mime.getType("jpg"),
            id: ".jpg",
            state: false,
        },
        {
            key: "mime_type",
            value: mime.getType("pdf"),
            id: ".pdf",
            state: false,
        },
        {
            key: "mime_type",
            value: mime.getType("png"),
            id: ".png",
            state: false,
        },
        {
            key: "mime_type",
            value: mime.getType("pptx"),
            id: ".pptx",
            state: false,
        },
        {
            key: "mime_type",
            value: mime.getType("txt"),
            id: ".txt",
            state: false,
        },
        {
            key: "mime_type",
            value: mime.getType("xlsx"),
            id: ".xlsx",
            state: false,
        },
    ]);
    ...
    useEffect(() => {
        setMyDocumentsButton((employeeId) =>
            employeeId.map((doc) =>
                doc.key === "content_owner" ? { ...doc, value: empID } : doc,
            ),
        );
    }, [empID]);
    ...
    useEffect(() => {
        setFilters((prev) => {
            const withoutRoles = prev.filter(
                (f) => f.key !== "assigned_role" && f.key !== "content_owner",
            );
            ...
            if (tab === "OwnedByMe") {
                selectedOwned = myDocumentsButton.find(
                    (f) => f.value === empID,
                );
            }
                                                            ...
                                                            myDocumentsButton.map(
                                                                (option) => (
                                                                    <div
                                                                        ...
                                                                        className="flex items-center justify-between"
                                                                    >
                                                                        <label className="flex px-4 py-1 ml-2 justify-center items-center  text-gray-800 rounded-md  text-xs w-36">
                                                                            {
                                                                                option.id
                                                                            }
                                                                        </label>
                                    ...
                                    >
                                        ...
                                        <div className="space-y-2">
                                            ...
                                            <ul className="text-xs text-muted-foreground space-y-1">
                                                ...
                                                <li>
                                                    Edit document metadata and
                                                    details
                                                </li>
                                                <li>
                                                    Delete documents you no
                                                    longer need
                                                </li>
                                                <li>
                                    ...
                                    {table
                                        ...
                                        .map((headerGroup) => (
                                            <TableRow key={headerGroup.id}>
                                                ...
                                                <TableHead className="text-[#0b4461] px-5 text-right pr-30">
                                                    Actions
                                                </TableHead>
                                            </TableRow>
                                        ))}
