            ...
            <Card className="w-max-[500px] h-full mb-5">
                <CardContent className="py-4 px-8 flex flex-row gap-3 items-center h-full">
                    ...
                    <div className="grid grid-cols-2 gap-y-5 gap-x-1">
                        <StatItem icon={FileText} value={30} label="TOTAL DOCUMENTS" />
                        <StatItem icon={UsersRound} value={12} label="TOTAL EMPLOYEES" />
                        <StatItem icon={UserPen} value={5} label="TOTAL UNDERWRITERS" />
                        <StatItem icon={UserLock} value={6} label="TOTAL BUSINESS ANALYSTS" />
