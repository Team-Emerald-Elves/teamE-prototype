...
const pernStack = [
    {
        ...
        description: "Relational Database for reliable data storage.",
    },
    {
        title: "Express",
        image: "/Expressjs.png",
    ...
    },
    {
        ...
        description: "Runtime program for server-side part of program.",
    },
];
...
const additionalTools = [
    {
        title: "Vite",
        image: "/Vitejs-logo.svg.png",
        description: "Fast frontend tooling and development server.",
    },
    {
        title: "Tailwind CSS",
        image: "/Tailwind_CSS_Logo.svg.png",
    ...
    },
    {
        title: "ShadCN",
        image: "/ShadCN.png",
        description: "Beautifully styled React components.",
    },
    {
        title: "React Router",
    ...
    {
        title: "Render",
        image: "/render-render.png",
        description: "Service for compute and database hosting.",
    },
    {
        title: "Postman",
        image: "/Postman.png",
        description: "API platform for building and testing requests.",
    },
    {
        title: "WebStorm",
        image: "/Webstorm.png",
        description: "Intelligent IDE for modern JavaScript development.",
    },
    {
        title: "VSCode",
        image: "/vscode.png",
    ...
    },
    {
        title: "SQL",
        image: "/SQL.png",
        description: "Standard language for querying relational databases.    ",
    },
    {
        title: "Prisma",
        image: "/prismaHD.png",
...
function CreditCard({
    ...
    return (
        <Card className="flex flex-col items-center justify-center text-center p-6 gap-4 bg-white rounded-2xl shadow-sm min-h-[200px] w-full">
            ...
            <div>
                <h3
                    className="font-bold text-lg text-[#003151]"
