    ...
    if(roles.includes("administrator")) {
        return (
            <>
                ...
                <div className="max-w-10xl mx-auto px-10 w-full py-7">
                            ...
                            <div className="flex items-center mb-4">
                                ...
                                <div className="relative inline-block text-left">
                                        <button
                                            ...
                                            className="flex px-4 text-sm py-1 ml-2 bg-gray-400 text-white rounded-md duration-200 hover:bg-gray-500 ease-in-out hover:scale-105 active:scale-99 cursor-pointer"
                                        >
                                ...
                                <TableHeader className="bg-[#ecf4f9] text-[#0b4461]">
                                    {table.getHeaderGroups().map((headerGroup) => (
                                        <TableRow key={headerGroup.id}>
                                            ...
                                            <TableHead className="text-[#0b4461] px-5">
                                        ...
                                        return (
                                            ...
                                            <TableRow key={row.id} className="h-14">
                                                ...
                                                {row.getVisibleCells().map((cell) => (
                                                    <TableCell key={cell.id} className="px-5 py-0.5 text-left whitespace-normal text-xs">
                                                ...
                                                <TableCell>
                                                    <div className="flex items-center gap-1 justify-end">
                                                        ...
                                                        {/*</a>*/}
                                                        <Button size="icon" className="hover:bg-primary/90 cursor-pointer" onClick={async () => await handleDownload(doc)}>
                                                            <HugeiconsIcon icon={Download01Icon} />
                                                        </Button>
                                                        <Button variant="outline" size="icon" className="text-base bg-[#c5e6e8] hover:bg-[#c5e6e8]/70 cursor-pointer border-0 text-secondary-foreground" onClick={async () => {
                                                            const token = await getToken();
                                                            await setDocumentLock(token, doc.id, true, setReload)
                                                        }}><Lock color="#3e9392"/></Button>
                                                    </div>
                                                </TableCell>
                                                    ):
                                                    doc.lock === empID ?(
                                                <TableCell>
                                                    <div className="flex gap-2 justify-end">
                                                        ...
                                                        <Button variant="outline" size="icon" className="text-base bg-[#c5e6e8] text-secondary-foreground" onClick={async () => {
                                                            const token = await getToken();
                                                ...
                                                <TableRow key={row.id} className="bg-[#e6e8e8] h-14">
                                                    <FavoriteStar
                                                        doc={doc}
                                                        onToggleOn={(doc) => toggleFavorite(doc, false)}
                                                        onToggleOff={(doc) => toggleFavorite(doc, true)}
                        ...
                        <div className="flex flex-col">
                            <div className="flex items-center mb-4">
                                ...
                                <div className="relative inline-block text-left">
                                    <button
                                        onClick={() => setIsDropdownOpen(!isDropdownOpen)}
                                        className="flex px-4 py-1 ml-2 bg-gray-400 text-white rounded-md hover:bg-gray-600 duration-200 ease-in-out hover:scale-105 active:scale-95 text-sm cursor-pointer"
                                    >
                                        <div className="flex items-center justify-center pr-1">
                                            <HugeiconsIcon icon={SlidersHorizontalIcon} size={18} />
                                        </div>
                                                        ...
                                                        <TableCell>
                                                            <div className="flex items-center justify-end gap-2">
                                                                ...
                                                                <Button variant="outline" size="icon"
                                                                        className="text-base bg-[#c5e6e8] hover:bg-[#c5e6e8]/70 cursor-pointer border-0 text-secondary-foreground"
                                                                        onClick={async () => {
                                                                            const token = await getToken();
                                                                            await setDocumentLock(token, doc.id, true, setReload)
                                                                        }}><Lock/></Button>
