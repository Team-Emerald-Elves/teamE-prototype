...
var clerkClient = (0, express_1.createClerkClient)({ secretKey: process.env.CLERK_SECRET_KEY });
function createEmployeeRoute(req, res) {
    return __awaiter(this, void 0, void 0, function () {
        var employee, user, error_1;
        var _this = this;
        return __generator(this, function (_a) {
            switch (_a.label) {
                ...
                case 1:
                    _a.trys.push([1, 3, , 4]);
                    return [4 /*yield*/, clerkClient.users.createUser({
                ...
                case 4:
                    ...
                    prisma_ts_1.prisma.employee.create({
                        data: __assign({}, employee)
                        ...
                        return __generator(this, function (_b) {
                            switch (_b.label) {
                                case 0:
                                    ...
                                    return [4 /*yield*/, prisma_ts_1.prisma.bucketMeta.create({
                                            data: {
